...
export const diaryEntries: DiaryEntry[] = [
  {
    ...
    title: "夏野菜の収穫と防除",
    summary:
      "トマトとピーマンを収穫し、防除作業を行った。トマトは糖度が高く、実がしっかり色づいており、出荷に適した品質だった。ピーマンもサイズがそろっていて形が良かったため、予定どおりの収量を確保できた。防除はベストガードを適切な濃度で散布し、病害虫の発生を抑えることを目的として実施した。さらに畝間の除草も並行して行い、圃場全体を清潔に保つことで作物の健全な生育環境を整えた。",
    details: [
      {
        id: "d01",
        type: "crop",
